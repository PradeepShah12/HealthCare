const en = {
  ...
  auth: {
    signup: {
      ...
      enterInformation:
        "Enter Your Information Below. Please create a new password. Passwords must be at least 8 character long and include a special character.",
      firstName: "First Name",
      lastName: "Last Name",
