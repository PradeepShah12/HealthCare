...
export const StepTrackerScreen: FC<StepTrackerScreenProps> = observer(function StepTrackerScreen() {
  ...
  const fetchStepRateHistory = async () => {
    try {
      const response = await axios.post("https://c1b4-165-225-114-126.ngrok-free.app/api/user/activity/stepcounter/getsteps",
        {
  ...
  const addStepRate = async () => {
    ...
    if (!isNaN(parsedStepRate)) {
      ...
      try {
        const response = await axios.post("https://c1b4-165-225-114-126.ngrok-free.app/api/user/activity/stepcounter/insertsteps", {
          UserID: UserID, // Replace with actual user ID
  ...
  const deleteStepRate = async (id: string, stepRate: number) => {
    try {
      const response = await axios.delete("https://c1b4-165-225-114-126.ngrok-free.app/api/user/activity/stepcounter/deletesteps", {
