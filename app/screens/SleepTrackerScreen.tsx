...
const Etime= new Date("2024-05-31")
    ...
    try {
      const response = await axios.post("https://c1b4-165-225-114-126.ngrok-free.app/api/user/activity/sleep/getsleep", {
  ...
  const addSleepRecord = async () => {
    ...
    const now= new Date()
    try {
      const response = await axios.post("https://c1b4-165-225-114-126.ngrok-free.app/api/user/activity/sleep/insertsleep", {
        UserID: UserID, // Replace with actual user ID
        SleepDuration: newSleepDuration,
  ...
  const deleteSleepRecord = async (id: string) => {
    try {
      const response = await axios.delete("https://c1b4-165-225-114-126.ngrok-free.app/api/user/activity/sleep/deleteSleepRecord", {
